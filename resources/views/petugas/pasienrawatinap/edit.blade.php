        ...
        <div class="card-body">
            ...
            <form action="{{ route('petugas.pasienrawatinap.update', $item->id) }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select"
                            aria-label="Default select example"name="jenis_kelamin"value="{{ $item->jenis_kelamin }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" aria-label="Default select example"
                            name="golongan_darah"value="{{ $item->golongan_darah }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" aria-label="Default select example"
                            name="warga_negara"value="{{ $item->warga_negara }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control"
                            name="nama_kepala_keluarga"value="{{ $item->nama_kepala_keluarga }}">
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control"
                            name="pekerjaan_kepala_keluarga"value="{{ $item->pekerjaan_kepala_keluarga }}">
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" aria-label="Default select example"
                            name="status_asuransi"value="{{ $item->status_asuransi }}">
